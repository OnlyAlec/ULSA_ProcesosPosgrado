...
function insertOneStudent($ulsaId, $name, $lastname, $career, $email)
{
    ...
    try {
        ...
        $stmt = $db->prepare(
            'INSERT INTO name (first_name, last_name) VALUES (:first_name, :last_name) RETURNING id',
        );
        $stmt->execute([
            ':first_name' => $name,
            ':last_name' => $lastname,
        ...
        $stmt = $db->prepare(
            'INSERT INTO student (ulsa_id, name_id, program_id, email) VALUES (:ulsa_id, :name_id, :program_id, :email)',
        );
        $stmt->execute([
            ':ulsa_id' => $ulsaId,
            ':name_id' => $nameId,
